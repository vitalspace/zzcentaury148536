    ...
    for await (const i of json) {
      ...
      if (type === 'web') {
        ...
        if (await page.$('iframe') !== null) {
            ...
            if (await frame.$('button') !== null) {
              const button = await frame.$('button');
              console.log('pasando por el iframe')
              button.click();
            }

            if(await frame.$('a[href="#"]') !== null) {
              const button = await frame.$('a[href="#"]')
              console.log('pasando por el iframe 2')
              button.click()
            }
        }
        ...
        if (await page.$('.clickme') !== null) {
          ...
          console.log('pasando por el direclink 1')
          await page.waitFor(10000)
          await page.$eval('.clickme', elem => elem.click());
          console.log('pasando por el direclink 2')
          await page.waitFor(10000)
          await page.$eval('.clickme', elem => elem.click());
          console.log('pasando por el direclink 3')
          await page.waitFor(10000)
          await page.$eval('.clickme', elem => elem.click());
          console.log('pasando por el direclink 4')
          await page.waitFor(10000)
          await page.$eval('.clickme', elem => elem.click());
          console.log('pasando por el direclink 5')
        }
      }
